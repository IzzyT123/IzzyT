...
export function ChangeableFeaturedArticleCard({
  ...
  return (
    <article className="relative w-full max-w-[min(100%,52rem)] overflow-hidden border border-emerald-900/20 bg-surface shadow-[0_2px_12px_-4px_rgba(0,0,0,0.1)] ring-1 ring-emerald-900/15">
      <div
      ...
      <div className="relative z-10 border-l-[3px] border-emerald-700/55 py-3.5 pl-4 pr-16 sm:py-4 sm:pl-5 sm:pr-24 md:pr-28">
        ...
        <a
          ...
          target="_blank"
          className="relative z-10 mt-3 inline-flex items-center gap-1.5 border border-emerald-900/20 bg-background px-3 py-2 text-sm font-medium text-foreground shadow-sm transition hover:border-emerald-800/35 hover:bg-[var(--surface-muted)]"
        >
          {hrefLabel}
